...
#ifndef ZSINAPPPURCHASEKIT_SWIFT_H
#define ZSINAPPPURCHASEKIT_SWIFT_H
...
///
@property (nonatomic, copy) NSString * _Nonnull productPurchaseId;
///
@property (nonatomic, copy) NSString * _Nonnull channelReferenceId;
///
@property (nonatomic, copy) NSString * _Nonnull productCode;
///
@property (nonatomic, copy) NSString * _Nonnull quantity;
///
@property (nonatomic, copy) NSString * _Nonnull purchaseDate;
///
@property (nonatomic, copy) NSString * _Nonnull purchaseDateFormatted;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// \param productIDs The list of IAP product ids that need to be fetched from app store.
///
/// \param completion Returns array of SKProduct objects. If the call to app store fails, it returns an error in the completion block.
///
+ (void)getIAPProductsWithProductIDs:(NSArray<NSString *> * _Nonnull)productIDs completion:(void (^ _Nonnull)(NSArray<SKProduct *> * _Nonnull, ZSError * _Nullable))completion;
...
/// \param completion It will return the list of IAP Products created in Zoho Subscriptions. If the call to subscription server or app store fails, it returns an error in the completion block.
///
+ (void)restoreIAPProductsPurchaseWithCompletion:(void (^ _Nonnull)(NSArray<ZSIAPProductPurchaseDetail *> * _Nonnull, ZSError * _Nullable))completion;
...
/// This method will be called whenever the IAP products has been created for the user in Zoho Subscriptions.
/// \param iapProducts The created IAP products will be passed as array.
///
- (void)didIAPProductsUpdatedWithIapProducts:(NSArray<ZSIAPProductPurchaseDetail *> * _Nonnull)iapProducts;
@end
